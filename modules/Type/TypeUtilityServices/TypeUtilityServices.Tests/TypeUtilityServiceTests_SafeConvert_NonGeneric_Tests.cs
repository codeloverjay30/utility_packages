...
namespace TypeUtilityServices.Tests
{
    ...
    {
        #region SafeConvert Tests (For non-generic method)
#if NETCOREAPP3_0_OR_GREATER
        [Fact]
        public void SafeConvert_NonGenericVersion_ShouldReturnDefault_WhenValueIsNull()
        {
            // Act
        ...
        [Fact]
        public void SafeConvert_NonGenericVersion_ShouldReturnDefault_WhenValueIsDBNull()
        {
            // Act
        ...
        [Fact]
        public void SafeConvert_NonGenericVersion_ShouldConvertSuccessfully_WhenValidValueProvided()
        {
            // Act
        ...
        [Fact]
        public void SafeConvert_NonGenericVersion_ShouldReturnDefault_WhenConversionFails()
        {
            // Act
        ...
        [Fact]
        public void SafeConvert_NonGenericVersion_ShouldHandleDateTime_Successfully()
        {
            // Arrange
        ...
        #region SafeConvert Extended Tests (For non-generic method)
#if NETCOREAPP3_0_OR_GREATER
        ...
        public void SafeConvert_NonGenericVersion_ShouldHandleBooleanConversion_Successfully(object value , bool expected)
        {
            // Act
        ...
        [Fact]
        public void SafeConvert_NonGenericVersion_ShouldHandleEnumConversion_FromValidStringAndInt()
        {
            // Arrange
            var stringValue = "Utc";
        ...
        [Fact]
        public void SafeConvert_NonGenericVersion_ShouldReturnDefault_WhenNumericOverflowOccurs()
        {
            // Arrange
        ...
        public void SafeConvert_NonGenericVersion_ShouldHandleNumericPrecision_Correctly(object input , object expected)
        {
        ...
        [Fact]
        public void SafeConvert_NonGenericVersion_ShouldHandleGuidConversion_Successfully()
        {
            // Arrange
        ...
        [Fact]
        public void SafeConvert_NonGenericVersion_ShouldReturnDefault_WhenTargetTypeIsIncompatible()
        {
            // Arrange
            ...
            var result = (int?)_service.SafeConvert(complexObject,typeof(int));

            // Assert
            (result == null || result == default(int)).Should().BeTrue();
        }

        [Fact]
        public void SafeConvert_NonGenericVersion_ShouldHandleNullableEnum_WithNullValue()
        {
            // Act
            var result = (DateTimeKind?)_service.SafeConvert(null,typeof(DateTimeKind?));
        ...
        public void SafeConvert_NonGenericVersion_ShouldReturnDefault_WhenStringIsInvalidOrEmpty(string input , Type targetType , object expectedDefault)
        {
            // 這裡可以使用反射來呼叫泛型方法，或直接寫多個 Fact
            var result = (int?)_service.SafeConvert(input,typeof(int));
            (result == null || result == default(int)).Should().BeTrue();
        }
        ...
        #region Specialized Conversion Tests (For non-generic method)
#if NETCOREAPP3_0_OR_GREATER

        [Fact]
        public void SafeConvert_NonGenericVersion_ShouldHandleDateTimeToStringAndBack_Successfully()
        {
            // Arrange
            ...
            // Act
            var convertedDate = (DateTime)_service.SafeConvert(dateString,typeof(DateTime));
        ...
        [Fact]
        public void SafeConvert_NonGenericVersion_ShouldHandleTimeSpanToIntAndBack_BehaviorCheck()
        {
            // Arrange
            ...
            var finalSpan = (TimeSpan)_service.SafeConvert(intResult,typeof(TimeSpan));
        ...
        [Fact]
        public void SafeConvert_NonGenericVersion_ShouldHandleTimeSpanToDouble_Successfully()
        {
            ...
            var result = (TimeSpan)_service.SafeConvert(totalMs,typeof(TimeSpan));
        ...
        [Fact]
        public void SafeConvert_NonGenericVersion_DateTime_RoundTrip_ShouldMaintainValue()
        {
            // Arrange
            ...
            // Act
            var converted = (DateTime)_service.SafeConvert(isoString,typeof(DateTime));
        ...
        public void SafeConvert_NonGenericVersion_DateTime_VariousFormats_ShouldSucceed(string dateStr)
        {
            // Act
            var result = (DateTime)_service.SafeConvert(dateStr,typeof(DateTime));
        ...
        [Fact]
        public void SafeConvert_NonGenericVersion_DateTime_InvalidString_ShouldReturnDefault()
        {
            // Arrange
            string invalidDate = "NotADateString";

            // Act
            var result = (DateTime?) _service.SafeConvert(invalidDate,typeof(DateTime));

            // Assert
            (result == null || result == default(DateTime)).Should().BeTrue();
        }
